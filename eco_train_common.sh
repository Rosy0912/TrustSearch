#!/bin/bash
# Common training args for all EcoSearch v2 ablations.
# Usage: source this file after setting ECO_BUDGET_INIT, ECO_FLOOR,
#        EXPERIMENT_NAME, N_GPU, PARTITION, NODELIST, MINI_BATCH, MEM.
